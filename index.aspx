<%@ page language="C#" autoeventwireup="true" inherits="preview_dotnet_templates_1_col_portfolio_index, App_Web_8yvdwrwx" %>
...
<head runat="server">
    ...
    <title>Freca Mining & Manufacturing</title>
    <!-- Bootstrap Core CSS -->
        ...
        <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="Default.aspx"><i class="fa fa-diamond"></i>Freca Mining & Manufacturing Ltd.</a>
                </div>
                <div class="navbar-collapse collapse">
                    <!-- Left nav -->
                    <ul class="nav navbar-nav navbar-right">
                        <li class="active"><a href="Default.aspx" runat="server">Home</a></li>
                        <li><a href="Projects.aspx" runat="server">Projects</a></li>
                        <li class="dropdown"><a href="blog.aspx" class="dropdown-toggle" data-toggle="dropdown"
                            role="button" aria-haspopup="true" aria-expanded="false" runat="server">Products & Services<span class="caret"
                                runat="server"></span></a>
                        ...
                        <li><a href="portfolio.aspx" runat="server">Key Personnel</a></li>
                        <li><a href="contact.htm" runat="server">Contact Us</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div id="carousel-example-generic" class="carousel slide carousel-fade" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="item active one">
                    ...
                    <div class="main-text hidden-xs">
                        <div class="col-md-12 text-center">
                            <h1>Let your <b class="yellow">smile</b> change the <b class="yellow">world</b><br />
                ...
                <div class="item four">
                    ...
                    <div class="main-text hidden-xs">
                        <div class="col-md-12 text-center">
                            <h1>You cannot<b class="yellow"> FRECA</b> in <b class="yellow">God</b><br />
                                <span class="span">until you believe in yourself.</span></h1>
                            <div class="">
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-3 col-sm-12 col-md-pull-9 animated wow fadeInLeft" data-wow-delay="0.8s">
							<div class="fh5co-footer-logo"><a href="Default.aspx">Akshara</a></div>
